...
public class PassportEntity {
    ...
    public PassportEntity(final PassportEntity passportEntity) {
        this.customerEntity = passportEntity.customerEntity;
        this.passportNumber = passportEntity.passportNumber;
        this.issue = passportEntity.issue;
        this.expiry = passportEntity.expiry;
        this.authority = passportEntity.authority;
        this.gender = passportEntity.gender;
        this.flag = passportEntity.flag;
    }
