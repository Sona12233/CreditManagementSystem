...
public class ValidExpiryDate implements ConstraintValidator<com.example.acra.validation.annotations.ValidExpiryDate, PassportRequest> {


    @Override
    public void initialize(com.example.acra.validation.annotations.ValidExpiryDate constraintAnnotation) {
